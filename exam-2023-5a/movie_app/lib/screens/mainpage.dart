...
import 'package:movie_app/screens/main_section.dart';
import 'package:movie_app/screens/release_year_section.dart';
                ...
                TextButton(
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (_) => HomePage("Main Section", online)));
                    },
